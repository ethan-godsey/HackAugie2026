...
function downloadPDF(letter, name, insurerName) {
  ...
  <div class="instructions-page">
    ...
    <div class="step-list" style="margin-top:1.5rem">
      <div class="step"><div class="step-num">1</div><div class="step-body"><strong>Gather your enclosures</strong><p>Include copies (not originals) of: your Explanation of Benefits (EOB), any supporting documentation from your treating provider, and prior authorization records if applicable.</p></div></div>
      <div class="step"><div class="step-num">2</div><div class="step-body"><strong>Submit via portal <em>or</em> certified mail</strong><p><strong>Portal:</strong> Upload the signed PDF + enclosures through your insurer's member portal. Save the confirmation number.<br><strong>Mail:</strong> Print, sign, and send via USPS Certified Mail with Return Receipt to the address below.</p><div class="addr-box">${addrHtml}</div></div></div>
      <div class="step"><div class="step-num">3</div><div class="step-body"><strong>Keep a complete copy for your records</strong><p>Save the signed letter, all enclosures, your portal confirmation number or certified mail receipt. If your appeal is denied again, this packet is your evidence for escalation.</p></div></div>
      <div class="step"><div class="step-num">4</div><div class="step-body"><strong>If no response within 30 days</strong><p>File a complaint with the <strong>U.S. Department of Labor EBSA</strong> at <strong>dol.gov/EBSA</strong> or call 1-866-444-3272. Also file with your <strong>State Insurance Commissioner</strong>.</p></div></div>
    </div>
